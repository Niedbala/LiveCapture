...
namespace SmoReader
{
    public class PacketDecoder
    {
        ...
        DateTime _errorCutoffTs { get; set; }
        ...
        public PacketDecoder(DateTime errorCutoffTs, List<ParameterDefinition> parameterDefinitions, bool isLiveMode = true, IAircraftDataProvider aircraftDataProvider = null)
        {
            _errorCutoffTs = errorCutoffTs;
        ...
        public PacketReadResult DecodePacket(RawCapture packet, string aircraftName)
        {
            ...
            if (payloadPacket.DestinationAddress.ToString() != "127.0.0.1")
            {
                ...
                if (payloadLength < 104) return result;
                ...
                if (acraDateTimeSample < _errorCutoffTs)
                    return result;
